...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/update-in-progress-dark.svg?sanitize=true">
  <source media="(prefers-color-scheme: light)" srcset="assets/update-in-progress-light-2.svg?sanitize=true">
  <img alt="Update in progress" src="https://raw.githubusercontent.com/hesreallyhim/awesome-claude-code/master/assets/update-in-progress-light-2.svg?sanitize=true">
</picture>
