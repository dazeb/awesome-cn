...
[![Resource Landscape Overview](https://raw.githubusercontent.com/inoue0426/awesome-computational-biology/master/docs/overview.png)](https://inoue0426.github.io/awesome-computational-biology/overview.html)
...
If you use this list in papers, slides, or documentation, please cite this repository via [`CITATION.cff`](https://github.com/inoue0426/awesome-computational-biology/blob/master/./CITATION.cff) (also available through GitHub's **Cite this repository** button).
...
- Link validity is monitored by the [Link Check workflow](https://github.com/inoue0426/awesome-computational-biology/blob/master/./.github/workflows/link-check.yml).
...
- Data schema reference: [`docs/data/SCHEMA.md`](https://github.com/inoue0426/awesome-computational-biology/blob/master/./docs/data/SCHEMA.md).
...
- Contribution guide: [`contributing.md`](https://github.com/inoue0426/awesome-computational-biology/blob/master/./contributing.md).
